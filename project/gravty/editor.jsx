      ...
      <div className="row gap-8" style={{marginLeft:'auto'}}>
        ...
        {step === 5 ? (
          <Btn kind="primary" onClick={onSubmit}
            ...
            {submitState==='submitting' ? <><Icon name="Refresh" size={13}/> Submitting…</>
        ...
        <div className="row gap-6 wrap">
          {blackouts.map(b => (
            <div key={b.id} style={{display:'inline-flex', flexDirection:'column', gap:4}}>
              ...
              {!b.valid && (
                <span style={{display:'inline-flex', alignItems:'center', gap:4, fontSize:11, color:'var(--accent-red)', marginLeft:2}}>
                  <Icon name="AlertTriangle" size={11}/> {b.label} is outside your offer window (Jun 1–Jul 31)
                </span>
              )}
            </div>
          ))}
